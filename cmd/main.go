...
import (
	...
	"github.com/marius0711/k8s-operator-lab/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a7fd26aa.schwarz.io",
	...
	if err := (&controller.DataServiceReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "DataService")
		os.Exit(1)
	}
